...
<div id="content" class="bg2">
	<div id="colOne">
		<h2>Alumnos</h2><p>Esta sección esta destinada a los alumnos</p>
		<div align="center">	<img src="./img/alumnos.jpg" height="200px" width="300px"><br><br><br>
			<a href="./fechas.php">Fechas de exámen</a><br><br>			
			<a href="./egresados.php">Egresados</a><br><br>
			<a href="./apuntes.php">Apuntes</a><br><br>
			<a href="./trabajos.php">Trabajos hechos por<br> alumnos</a><br><br>
			</div>
	</div>
<?php
include("col2.php");
