...
<div id="content" class="bg2">
	...
	<div id="colOne">
		<h2>Egresados</h2>
		<p>El siguiente buscador le permitirá buscar a las personas egresadas de nuestra institución desde el año 1985 hasta el año 2008, por nombre, apellido o año de egreso.</p>
	<iframe frameborder="0" src="http://et12.host56.com/iframea.php" width="490px" height="300px">
	</iframe>
	</div>
<?php
include("col2.php");
