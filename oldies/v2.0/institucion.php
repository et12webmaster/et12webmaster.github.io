...
<div id="content" class="bg2">
	...
	<div id="colOne">
		...
		<br>
		<p align="center"><a id="single_image" href="./images/Escuela/Escuela.jpg"><img src="./images/Escuela/Escuela.jpg" width="300px" height="400px"></a></p>
	
		<div align="center">
			<a href="./rhistorica.php">Rese&ntilde;a Hist&oacute;rica</a><br><br>
			<a href="./autoridades.php">Autoridades</a><br><br>			
			<a href="./infraestructura.php" >Infraestructura</a><br><br>
			<a href="./materias.php" >Departamentos</a><br><br>
			<a href="./galeria.php" >Galería de Fotos</a><br><br>			
		</div>
